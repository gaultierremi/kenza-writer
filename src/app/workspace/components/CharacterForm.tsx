...
export default function CharacterForm({
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-3 p-4">
      ...
      <label className="flex flex-col gap-1">
        <span className="text-xs font-medium text-gray-600">Âge</span>
        <input
          value={values.age}
          onChange={set('age')}
          className="border rounded px-2 py-1 text-sm focus:outline-none focus:ring-1 focus:ring-blue-400"
      ...
      {(
        ...
        <label key={field} className="flex flex-col gap-1">
          ...
          <textarea
            ...
            onChange={set(field)}
            rows={2}
            className="border rounded px-2 py-1 text-sm resize-none focus:outline-none focus:ring-1 focus:ring-blue-400"
          />
        </label>
      ))}
